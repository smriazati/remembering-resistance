<template>
  <div ref="wrapper" class="introduction story-container">
    <!-- <header class="header">
      <h1>Meet Laura Oberlander</h1>
    </header>-->

    <section class="header-image header-image-contain">
      <figure class="image-wrapper">
        <img src="/media/1/laura-01.png" alt="" />
      </figure>
      <ScrollDownNudge />
    </section>
    <section class="story">
      ...
      <div class="text-wrapper">
        <div class="title"><h2>Meet Laura Oberlander</h2></div>
    ...
    <section class="story">
      <div class="image-wrapper">
        <img src="/media/1/laura-03.png" alt="" />
      </div>
      <div class="text-wrapper">
        <div class="paragraphs">
          <p>
    ...
    <section class="pull-quote pull-quote-row">
      <div class="image-wrapper">
        <img src="/media/1/laura-02.png" alt="" />
      </div>
    ...
    <section class="story">
      <div class="image-wrapper">
        <img src="/media/1/laura-05.png" alt="" />
      </div>
      <div class="text-wrapper">
        <div class="paragraphs">
          <p>
    ...
    <section class="pull-quote">
      <div class="image-wrapper">
        <img src="/media/1/laura-04.png" alt="" />
      </div>
      <div class="quote-wrapper">
        <div class="paragraphs">
          <p>
