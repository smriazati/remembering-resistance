  ...
  <div ref="wrapper" class="introduction story-container">
    <section class="header-image">
      <figure class="image-wrapper">
        <img src="/media/1/miriam-04.png" alt="" />
      </figure>
    </section>
    <section class="story">
      <div class="image-wrapper">
        <img src="/media/1/miriam-02.png" alt="" />
      </div>
      <div class="text-wrapper">
        <div class="title"><h2>Meet Miriam Schwartzman Kouts</h2></div>
    ...
    <section class="story">
      <div class="image-wrapper">
        <img src="/media/1/miriam-03.png" alt="" />
      </div>
      <div class="text-wrapper">
        <div class="paragraphs">
          <p>
    ...
    <section class="pull-quote pull-quote-row">
      <div class="image-wrapper">
        <img src="/media/1/miriam-01.png" alt="" />
      </div>
    ...
    <section class="story">
      <div class="image-wrapper">
        <img src="/media/1/miriam-05.png" alt="" />
      </div>
      <div class="text-wrapper">
        <div class="paragraphs">
          <p>
